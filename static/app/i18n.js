...
const translations = {
    'zh-CN': {
        ...
        'guide.client.curl.title': '通用 cURL 调用',
        ...
        'oauth.kiro.apiKey': 'Kiro API Key (ksk_...)',
        'oauth.kiro.apiKeyDesc': '直接输入以 ksk_ 开头的 API 密钥，免 OAuth 认证与 Token 刷新',
        'oauth.kiro.apiKeyModalTitle': '添加 Kiro API Key 节点',
        'oauth.kiro.apiKeyModalDesc': '输入以 ksk_ 开头的 Kiro API Key。系统将使用官方 Rust Client 协议直接请求 AWS CodeWhisperer，免去 OAuth Refresh Token 过期失效的烦恼。',
        'oauth.kiro.apiKeyInputLabel': 'Kiro API Key',
        'oauth.kiro.apiKeyCustomNameLabel': '节点自定义名称',
        'oauth.kiro.apiKeyCustomNamePlaceholder': '例如: Kiro-Primary-Key',
        'oauth.kiro.apiKeyEmptyError': '请输入有效的 Kiro API Key',
    ...
    'en-US': {
        ...
        'header.store': 'Store',
        'header.videoTutorial': 'Tutorials',
        'guide.client.curl.title': 'General cURL Request',
        ...
        'oauth.kiro.apiKey': 'Kiro API Key (ksk_...)',
        'oauth.kiro.apiKeyDesc': 'Direct API Key authorization (ksk_...) without OAuth login or refresh tokens',
        'oauth.kiro.apiKeyModalTitle': 'Add Kiro API Key Node',
        'oauth.kiro.apiKeyModalDesc': 'Enter a Kiro API Key starting with ksk_. The proxy will authenticate directly using the official Rust Client protocol without expiring OAuth refresh tokens.',
        'oauth.kiro.apiKeyInputLabel': 'Kiro API Key',
        'oauth.kiro.apiKeyCustomNameLabel': 'Node Custom Name',
        'oauth.kiro.apiKeyCustomNamePlaceholder': 'e.g. Kiro-Primary-Key',
        'oauth.kiro.apiKeyEmptyError': 'Please enter a valid Kiro API Key',
